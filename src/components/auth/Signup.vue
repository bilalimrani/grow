                    ...
                    <div class="login100-form validate-form">
                        ...
                        <form class="login100-form validate-form" @submit.prevent="signup">
                          <div class="wrap-input100 validate-input m-b-16">
                            <input class="input100" type="text" v-model="fname" name="fname" placeholder="First Name" v-validate="'required'" data-vv-delay="1000">
                        ...
                        <div class="wrap-input100 validate-input m-b-16">
                            <input class="input100" type="text" name="lname" v-model="lname" placeholder="Last Name" v-validate="'required'" data-vv-delay="1000">
                            <span class="focus-input100"></span>
                             <span class="symbol-input100">
                                <span class="lnr lnr-user"></span>
                            </span>
                        ...
                        <div class="wrap-input100 validate-input m-b-16">
                            <input class="input100" @change="updateEmailError" v-validate="`required|email|emailExist:${emailExist}`" data-vv-delay="1000" type="text" name="email" v-model="email" placeholder="Email">
                            <span class="focus-input100"></span>
                              <span class="symbol-input100">
