        ...
        <div class="row-fluid plans">
            <div class="plan-sel" v-for="plan in plans" v-bind:key="plan.id">
                ...
                <div class="plan-data">
                  ...
                  <div class="plan-price" v-if="plan.name.toLowerCase() == 'monthly'"><p><strong>{{'$' + plan.price}}</strong></p>
                    <p class="tenure-label">per month</p>
                  </div>
                  <div class="plan-price" v-if="plan.name.toLowerCase() == 'weekly'"><p><strong>{{'$' + plan.price}}</strong></p>
